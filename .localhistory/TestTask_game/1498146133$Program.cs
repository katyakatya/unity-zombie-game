...
namespace TestTask_game
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Thread thread = new Thread(() => TryToGuess(player, weightOfBasket, new object()));
                thread.Start();
            }
        ...
        private static void TryToGuess(IPlayer player, int weightOfBasket, object objectToLock)
        {
            lock (objectToLock)
            {
                bool IsWinner = false;
